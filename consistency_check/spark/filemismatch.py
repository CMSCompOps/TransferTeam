...
class OptionParser():
    def __init__(self):
        ...
        self.parser.add_argument("--timestamp",action="store",dest="timestamp",default=7,help=msg,type=int)
...
def fileMismatch(args):
    ...
    if args.phedex_status == 'present' and args.dbs_status == 'invalid':
        working_set = (dbs_files
             ...
             .select('input_campaign','d_dataset','d_last_modified_by','f_logical_file_name')    # you can select more columns for detail info
             .distinct())
